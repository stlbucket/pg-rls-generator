...
-- alter schema public owner to graphile_starter;

revoke all on schema public from public;
grant all on schema public to graphile_starter;

create schema app_public;
grant usage on schema public, app_public to graphile_starter_visitor;
...
alter default privileges in schema public, app_public, app_hidden grant usage, select on sequences to graphile_starter_visitor;
alter default privileges in schema public, app_public, app_hidden grant execute on functions to graphile_starter_visitor;
...
grant select on app_public.users to graphile_starter_visitor;
-- NOTE: `insert` is not granted, because we'll handle that separately
grant update(username, name, avatar_url) on app_public.users to graphile_starter_visitor;
...
grant select on app_public.user_emails to graphile_starter_visitor;
grant insert (email) on app_public.user_emails to graphile_starter_visitor;
-- No update
grant delete on app_public.user_emails to graphile_starter_visitor;
...
grant select on app_public.user_authentications to graphile_starter_visitor;
grant delete on app_public.user_authentications to graphile_starter_visitor;
...
grant execute on function app_public.change_password(text, text) to graphile_starter_visitor;
...
grant select on app_public.organizations to graphile_starter_visitor;
grant update(name, slug) on app_public.organizations to graphile_starter_visitor;
...
grant select on app_public.organization_memberships to graphile_starter_visitor;
...
-- grant select on app_public.organization_invitations to graphile_starter_visitor;
