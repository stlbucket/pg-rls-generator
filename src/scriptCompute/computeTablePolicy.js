...
function computePolicy (policyDefinition, policyReadability, variables, table) {
  ...
  const allPgrRoleGrants =  Object.keys(policyDefinition.roleGrants).reduce(
    (allGrants, roleName) => {
  ...
  // const allowedPgrRoleGrants = allPgrRoleGrants
  const allowedPgrRoleGrants = allPgrRoleGrants.map(
  ...
  const deniedPgrRoleGrants = allPgrRoleGrants.map(
    roleGrant => {
      return {
        ...roleGrant,
  ...
  const impliedPgrRoleGrants = allPgrRoleGrants.map(
    roleGrant => {
      return {
        ...roleGrant,
  ...
  const verboseVariables = {
    verbose: true,
    deniedPgrRoleGrants: deniedPgrRoleGrants,
    impliedPgrRoleGrants: impliedPgrRoleGrants
  }
  ...
  const regularVariables = {
    ...
    allowedPgrRoleGrants: allowedPgrRoleGrants,
